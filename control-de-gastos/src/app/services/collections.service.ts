...
export class CollectionsService {
 ...
 async delete(collectionName: string, id: string) {
  ...
  getAllWhereSnapshot<T = ICollection>(collectionName: string, querys: QueryCompositeFilterConstraint): Observable<T[]> {
  ...
  getAllWhereSnapshot2<T = ICollection>(collectionName: string, querys: QueryCompositeFilterConstraint,order:string,forma:OrderByDirection): Observable<T[]> {
